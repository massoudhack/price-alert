...
string   g_sentFile = "JC_sent_pos_test.txt";
...
bool SendPosition(long pos_id, int total_deals)
  {
   ...
   string resp="";
   bool ok = PostJSON("/api/mt4/test", json, resp);
   if(ok)
...
void DrawButton()
  {
   ...
   ObjectSetString(0,b,OBJPROP_TEXT,"📤  ارسال TEST به Journal");
   ObjectSetInteger(0,b,OBJPROP_COLOR,clrWhite);
   ObjectSetInteger(0,b,OBJPROP_BGCOLOR,C'60,30,80');
